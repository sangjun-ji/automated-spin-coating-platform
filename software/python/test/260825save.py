...
PROCESS_RECIPE = [
    ...
    {"step": "그리퍼", "x": None, "y": None, "z": None, "grip": 520, "delay": 0.5},
    ...
    {"step": "피펫 Z축 하강", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zp147000,120000", "pipette": None, "hotplate": None, "pump": None, "spin": None, "delay": 2.0},
    {"step": "피펫 흡입/장착", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zg50000,80", "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 2.0},
    {"step": "피펫 Z축 상승", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zp34000,120000", "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 2.0},
    ...
    {"step": "피펫 Z축 하강", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zp64000,120000", "pipette": None, "hotplate": None, "pump": None, "spin": None, "delay": 2.0},
    ...
    {"step": "피펫 Z축 하강", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zp115000,20000", "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 2.0},
    {"step": "흡입", "x":  None, "y": None, "z":None, "grip": None, "pip_z": None, "pipette":"Ia15000,100,10", "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 0.5},
    {"step": "피펫 Z축 상승", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zp34000,120000", "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 2.0},
    ...
    {"step": "이동", "x": None, "y": 162, "z":None, "grip": None, "pip_z": None, "pipette": None, "hotplate": None, "pump": None, "spin": None, "delay":  0.1},
    ...
    #SPIN ON
    {"step": "스핀코터 ON", "x": None, "y": None, "z": None, "grip": None, "pip_z": None, "pipette": None, "hotplate": None, "pump": None, "spin": 2000, "accel_time": 2.0, "spin_time": 50, "delay": 0.1},
    ...
    {"step": "해제", "x":  None, "y": None, "z":None, "grip": None, "pip_z": None, "pipette": "Dt16000,0", "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 0.5},
    ...
    {"step": "피펫 Z축 하강", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zp115000,20000", "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 0.1},
    ...
    #Anti-solvent 분사
    {"step": "분사", "x":  None, "y": None, "z":None, "grip": None, "pip_z": None, "pipette": "Da15000,50,150,80", "wait_spin_time": 40.0, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 0.1},     
    {"step": "피펫 Z축 상승", "x":  None, "y": None, "z":None, "grip": None, "pip_z": "Zp34000,120000", "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 0.1},
    ...
    #hot plate 1-1
    {"step": "X/Y/Z축 이동 동작", "x": 12.4, "y": None, "z": None, "grip": None, "delay": 0.1},
    {"step": "X/Y/Z축 이동 동작", "x": None, "y": 22.7, "z": None, "grip": None, "delay": 0.1},
    {"step": "X/Y/Z축 이동 동작", "x": None, "y": None, "z": 42, "grip": None, "delay": 0.1},
    {"step": "그리퍼", "x": None, "y": None, "z": None, "grip": 675, "delay": 0.1},
    {"step": "X/Y/Z축 이동 동작", "x": None, "y": None, "z": 10, "grip": None, "delay": 0.1}, 
        ...
        for idx, task in enumerate(PROCESS_RECIPE):
            ...
            if task.get('spin') is not None and odrv0 is not None:
                ...
                if target_rpm > 0:
                    ...
                    control_spin_cooter(odrv0, target_rpm, accel_time_sec=accel_time_val, recipe_start_time=spin_start_time)
                else:

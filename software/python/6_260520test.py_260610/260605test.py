...
PROCESS_RECIPE = [
    ...
    {"step": "이동", "x": None, "y":  None, "z":103, "grip": None, "pip_z": None, "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": None, "delay": 0.1},
     ...
     {"step": "이동", "x": None, "y":  None, "z":None, "grip": None, "pip_z": None, "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": 3800, "delay": 3},
     {"step": "이동", "x": None, "y": None, "z": None, "grip": None, "pip_z": None, "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": 0, "delay": 3.0},
     {"step": "이동", "x": None, "y": None, "z": None, "grip": None, "pip_z": None, "pipette": None, "hotplate": None, "pump": None, "valve": None, "spin": 0, "delay": 3.0},
]
...
def main():
    ...
    try:
        ...
        # 시작하자마자 펌프, 밸브, 팬에 '0(OFF)' 신호를 개별적으로 전송합니다.
        s_spin.write(b"P0\n") # 펌프 끄기
        time.sleep(0.1)
        s_spin.write(b"V0\n") # 밸브 끄기
        time.sleep(0.1)
